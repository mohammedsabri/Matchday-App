...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        matchTime.setOnClickListener() {
            val intent = Intent(this,
                MatchdatetimeActivity::class.java)
            startActivity(intent)
        }
    ...
    fun handleInserts() {
        insertBtn.setOnClickListener {
            try {
                dbHelper.insertData(nameTxt.text.toString(),positionTxt.text.toString(),
                    teamTxt.text.toString())
                clearEditTexts()
            }catch (e: Exception){
                e.printStackTrace()
        ...
        updateBtn.setOnClickListener {
            try {
                val isUpdate = dbHelper.updateData(idTxt.text.toString(),
                    ...
                    positionTxt.text.toString(), teamTxt.text.toString())
                if (isUpdate == true)
        ...
        viewBtn.setOnClickListener(
            View.OnClickListener {
                ...
                while (res.moveToNext()) {
                    ...
                    buffer.append("TEAM :" + res.getString(3) + "\n\n")
                }
                showDialog("Players Listing", buffer.toString())
            }
        )
    }
